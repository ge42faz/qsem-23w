...
\begin {equation}
\Delta = \sum_{d=0}^{\lceil \log_2 1+m \rceil - 1} 2^d \; a_d^r
\end {equation}

The additional term $\Delta$ in $H_{\text{cap}}$ is a result of this constraint
...
This is conveyed through the auxiliary variables $a_d^r \in \{0, \; 1\}$,
