...
variable $\sigma_i \in \{-1, 1\}$. This spin value governs the local magnetic
moment of the particle according to the shell model (appendix). Neighbouring
lattice sites influence each other, termed nearest neighbour interactions,
represented 
