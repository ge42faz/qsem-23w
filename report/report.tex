...
the theory of adiabatic quantum computation to evolve an easily prepared
...
\; \qvec{+}^{\otimes m}
\end {equation}
where $\qvec{+}^{\otimes m}$ is the uniform superposition obtained through
...
not least the VRP and its variants. These conversions
...
\section {Ising and QUBO equivalence}
